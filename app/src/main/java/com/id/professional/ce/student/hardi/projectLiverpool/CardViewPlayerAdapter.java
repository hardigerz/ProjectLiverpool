...
public class CardViewPlayerAdapter extends RecyclerView.Adapter<CardViewPlayerAdapter.CardViewHolder> {
    ...
    public class CardViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public CardViewHolder(View itemView) {
            ...
            tvclub = (TextView)itemView.findViewById(R.id.tv_item_club);
        ...
        public void onClick(View view) {
            Intent intent = new Intent(context, DetaillPlayerActivity.class);
